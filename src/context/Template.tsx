...
export const TemplateContextProvider = (props: PropsWithChildren) => {
    ...
    const setTemplateHandler = (template: keyof typeof Templates) => setFormTemplate(TemplateMap[template]);

    return (
        <TemplateContext.Provider value={{template: formTemplate, setTemplate: setTemplateHandler, navigateWithTemplate}}>
            {props.children}
